...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, required=False, default='MTST',
                        help='model name, options: [Autoformer, Informer, Transformer]')

    # data loader
    parser.add_argument('--data', type=str, required=False, default='custom', help='dataset type')
    parser.add_argument('--root_path', type=str, default='./dataset', help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='data41.csv', help='data file')
    parser.add_argument('--features', type=str, default='MS',
                        help='forecasting task, options:[M, S, MS]; M:multivariate predict multivariate, S:univariate predict univariate, MS:multivariate predict univariate')
    parser.add_argument('--target', type=str, default='100m风速（100m/s）', help='target feature in S or MS task')
    ...
    parser.add_argument('--patch_len_ls', type=str, default='4,8,12', help='list of patch length')
    ...
    parser.add_argument('--n_heads_ls', type=str, default='8', help='list of head number for MTST')
